...
.proc ArmorSpellHandler
	...
	.proc cast
		...
		bcc :+
			...
			rts
			alreadyHas: .byte " already has a high base armor class.",$a,0
		:
...
.proc DispelMagicSpellHandler
	...
	.proc cast
		...
		rts
		text1: .byte "All spells on ",0
		text2: .byte " are dispelled.",$a,0
	.endproc
.endproc
...
.proc BlessSpellHandler
	...
	.proc cast
		...
		beq :+
			...
			jsr text_writeNullString
			rts
			msg: .byte "The party is already blessed!",$a,0
		:
		ora #SPELL_BLESS
		sta partySpells+0
...
.proc AidSpellHandler
	...
	.proc cast
		...
		bcs :+
			...
			jsr text_writeNullString
			rts
			msg: .byte "The aid spell fails!",$a,0
		:
	...
	.proc hit
		...
		loop:
			...
			bcs continue
				...
				pla
				jmp break
				msg: .byte " has been disintegrated!",$a,0
...
.proc XanatharDeathSpellHandler
	...
	.proc hit
		...
		sec
		rts
		msg: .byte "The party has been hit by a death spell!",$a,0
	.endproc
.endproc
...
.proc spells_castSpell
		...
		:
			...
			beq :+
				...
				jsr text_writeNullString
				jmp returnFalse
				freeHandNeeded: .byte "You must have a free hand for this spell.",$a,0
			:
			...
			:
				...
				jsr text_writeNullString
				jmp returnFalse
				cantHaveTwo: .byte "You can't have two of this spell type active.",$a,0
			:
		freeHandNotNeeded:
